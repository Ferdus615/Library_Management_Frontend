...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row bg-(--clr-surface-a0) overflow-hidden">
      {/* Branding Section (Left Side) */}
      <div className="hidden lg:flex lg:w-1/2 flex-col items-center justify-center p-12 relative overflow-hidden bg-(--clr-surface-a0)">
        ...
        <div className="relative z-10 flex flex-col items-center gap-8 text-center">
          ...
          <div className="space-y-4 max-w-md">
            ...
            <p className="text-lg text-(--clr-surface-a50)">
              Manage books, reservations, and community insights in one elegant
              dashboard.
            </p>
          </div>
        </div>
      ...
      <div
        className="w-full lg:w-1/2 flex items-center justify-center p-4 sm:p-8 md:p-12 bg-(--clr-light-a0) 
      dark:bg-(--clr-surface-a0) relative"
      >
