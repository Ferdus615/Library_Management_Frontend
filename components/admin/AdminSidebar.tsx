  ...
  return (
    <>
      ...
      >
        ...
        {/* Bottom section */}
        <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-(--clr-surface-a20)">
          <Link
            href="/dashboard"
            className="flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium text-(--clr-surface-a50) 
              hover:bg-(--clr-surface-a10) hover:text-(--clr-light-a0) transition-all duration-200"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-5 w-5"
