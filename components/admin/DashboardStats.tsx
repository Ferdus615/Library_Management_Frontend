  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <StatCard
          title="Total Copies"
          value={stats?.totalCopies?.toLocaleString() ?? "0"}
        ...
        <StatCard
          title="Available"
          value={stats?.totalAvailableCopies?.toLocaleString() ?? "0"}
        ...
        <StatCard
          title="Damaged"
          value={stats?.totalDamagedCopies?.toLocaleString() ?? "0"}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <StatCard
          title="Librarians"
          value={stats?.totalLibrarian?.toLocaleString() ?? "0"}
        ...
        <StatCard
          title="Admins"
          value={stats?.totalAdmin?.toLocaleString() ?? "0"}
      ...
      {/* Activity & Finance Stats */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        <StatCard
          title="Active Loans"
          value={stats?.totalLoanedCopies?.toLocaleString() ?? "0"}
        ...
        <StatCard
          title="Overdue"
          value={stats?.totalOverdueCopies?.toLocaleString() ?? "0"}
