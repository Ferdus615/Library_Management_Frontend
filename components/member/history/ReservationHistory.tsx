          ...
          <div className="flex items-center gap-2">
            {res.status.toLowerCase() === "pending" && (
              <AdminActionButton
                ...
                className="bg-(--clr-danger-a10) hover:bg-(--clr-danger-a20) text-(--clr-danger-a10) hover:text-white rounded-xl text-[10px] font-black uppercase tracking-widest border border-(--clr-danger-a10)/10 transition-all active:scale-95"
              >
                Cancel Request
              </AdminActionButton>
            )}
