...
export default function ConfirmModal({
  ...
  return (
    <div className="fixed inset-0 z-100 flex items-center justify-center bg-black/50 backdrop-blur-xs">
      <div className="bg-(--clr-surface-a0) border border-(--clr-surface-a50)/30 rounded-2xl p-6 w-full max-w-sm shadow-2xl relative animate-in fade-in zoom-in duration-200">
